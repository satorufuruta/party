...
var UserRepository = class {
  ...
  async upsert(user) {
    ...
    ).bind(user.id, user.name, user.display_name).run();
  }
  async getById(id) {
...
var invokePagesFunction = /* @__PURE__ */ __name(async (handler, request, env2, params) => {
  const context2 = {
    ...
    params,
    functionPath: "",
    waitUntil: /* @__PURE__ */ __name((_promise) => {
    }, "waitUntil"),
...
// .wrangler/tmp/bundle-etQQEB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-etQQEB/middleware-loader.entry.ts
